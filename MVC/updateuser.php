...
<body>
  <form action="" method="post" enctype="multipart/form-data">
    ...
    <div class="icon">
      ...
      <img src="images/<?php echo $fetch->images?>" alt="" height="116px" style="border-radius: 50%;
    height: 80px;">
    </div>
    <div class="formcontainer">
      <div class="container">
        <label for="uname"><strong>Username</strong></label>
        <input type="text" placeholder="Enter Username" name="uname" id="uname" value="<?php echo $fetch->uname?>">

        <label for="mail"><strong>E-mail</strong></label>
        <input type="text" placeholder="Enter E-mail" name="mail" id="mail" value="<?php echo $fetch->uemail?>">

        <label for="psw"><strong>Password</strong></label>
        <input type="text" placeholder="Enter Password" name="psw" id="psw"value="<?php echo $fetch->password?>">

        <label for="cpsw"><strong>Confirm Password</strong></label>
        <input type="text" placeholder="Enter Password" name="cpsw" id="cpsw"value="<?php echo $fetch->password?>">
        ...
        <?php echo $fetch->images?>

      </div>
      <button type="submit" name="update" id="btn" onclick="return validate()"><strong>UPDATE</strong></a></button>
